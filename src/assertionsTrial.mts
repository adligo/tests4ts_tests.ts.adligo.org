...
export class AssertionsTrial extends ApiTrial {
  ...
  public static new() {
    ...
    public static readonly testEqualsArrayFailures = new Test(AssertionsTrial.CLAZZ_NAME +
  ...
  public static readonly testEqualsBooleanFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testEqualsI_StringFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testEqualsMapFailures = new Test(AssertionsTrial.CLAZZ_NAME +
  ...
  public static readonly testEqualsStringFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testEqualsArraySuccesses = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testEqualsI_StringSuccess = new Test(AssertionsTrial.CLAZZ_NAME +
  ...
  public static readonly testIsFalse = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsBooleanFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsI_EquatableSuccess = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsI_EquatableFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsI_EquatableStringSuccess = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsI_EquatableStringFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsI_StringSuccess = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsI_StringFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    // ...
    public static readonly testNotEqualsNanFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsNullFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsNumberFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsObjectFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsPrimitivesSuccess = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsStringFailures = new Test(AssertionsTrial.CLAZZ_NAME +
    ...
    public static readonly testNotEqualsUndefinedFailures = new Test(AssertionsTrial.CLAZZ_NAME +
  ...
  constructor() {
    super(AssertionsTrial.CLAZZ_NAME, [
        AssertionsTrial.testEqualsArrayFailures,
        AssertionsTrial.testEqualsBooleanFailures,
        ...
        AssertionsTrial.testEqualsI_StringFailures, AssertionsTrial.testEqualsI_StringSuccess,
        AssertionsTrial.testEqualsMapFailures,
     AssertionsTrial.testEqualsNanFailures, AssertionsTrial.testEqualsNullFailures,
        ...
        AssertionsTrial.testEqualsArraySuccesses,
      ...
      AssertionsTrial.testIsTrue, AssertionsTrial.testIsFalse,
        AssertionsTrial.testNotEqualsBooleanFailures,
        AssertionsTrial.testNotEqualsI_EquatableFailures, AssertionsTrial.testNotEqualsI_EquatableSuccess,
        AssertionsTrial.testNotEqualsI_EquatableStringFailures, AssertionsTrial.testNotEqualsI_EquatableStringSuccess,
        AssertionsTrial.testNotEqualsI_StringFailures, AssertionsTrial.testNotEqualsI_StringSuccess,
        AssertionsTrial.testNotEqualsNanFailures, AssertionsTrial.testNotEqualsNullFailures,
        AssertionsTrial.testNotEqualsNumberFailures, AssertionsTrial.testNotEqualsObjectFailures,
        AssertionsTrial.testNotEqualsPrimitivesSuccess,
        AssertionsTrial.testNotEqualsStringFailures, AssertionsTrial.testNotEqualsUndefinedFailures
    ]);
  }
}
