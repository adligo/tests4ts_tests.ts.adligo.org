...
export class EqualsRecursiveCheckerFastLevelTwoTrial extends ApiTrial {
  public static readonly CLAZZ_NAME = 'org.adligo.ts.tests4ts_tests.assertions.equals.EqualsRecursiveCheckerFastLevelTwoTrial';


  constructor() {
    super(EqualsRecursiveCheckerFastLevelTwoTrial.CLAZZ_NAME);
  }
