...
import {
    I_AssertionContext,
    I_ComparisionArrayInfo, I_ComparisionCollectionSizeInfo,
...
export class EqualsRecursiveCheckerFastLevelThreeTrial extends ApiTrial {
  ...
  testFastEqualsDeepLevelThreeArraySizeActualBiggerFailures(ac: I_AssertionContext) {
        ...
        ac.same(ComparisonNodeInfoType.CollectionSize, sizeNode.getInfoType(),
            "cNode1's child at index 7 should be an CollectionSize");
        ac.same(3, sizeNode.getExpectedSize(), "the sizeNode should have an expected size of 3");
      ac.same(4, sizeNode.getActualSize(), "the sizeNode should have an actual size of 4");
  ...
  testFastEqualsDeepLevelThreeArraySizeExpectedBiggerFailures(ac: I_AssertionContext) {
      ...
      ac.same(ComparisonNodeInfoType.CollectionSize, sizeNode.getInfoType(),
          "cNode1's child at index 7 should be an CollectionSize");
      ac.same(4, sizeNode.getExpectedSize(), "the sizeNode should have an expected size of 4");
      ac.same(3, sizeNode.getActualSize(), "the sizeNode should have an actual size of 3");
    ...
    testFastEqualsDeepLevelThreeArrayItemSuccess(ac: I_AssertionContext) {
        ...
        //deep first assertions
        let cNode1: I_ComparisionNode = result1.getComparisionNode();
        ac.isFalse(cNode1.hasChildInfo(), "cNode1 should have child info");
        ac.isTrue(cNode1.getChildInfoSize() == 0, "cNode1 should NOT have any children");
  ...
  testFastEqualsDeepLevelThreeMapItemFailures(ac: I_AssertionContext) {
    ...
    testFastEqualsDeepLevelThreeMapSuccess(ac: I_AssertionContext) {
        ...
        //deep first assertions
        let cNode1: I_ComparisionNode = result1.getComparisionNode();
        ac.isFalse(cNode1.hasChildInfo(), "cNode1 should NOT have child info");
        ac.same(0, cNode1.getChildInfoSize(), "cNode1 should have zero children");
